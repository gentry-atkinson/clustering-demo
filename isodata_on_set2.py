...
# cluster points
#points = [[2, 5], [2, 4], [2, 3], [8, 8], [7, 7], [6, 6], [-5, -4], [-6, -4], [-9, -4], [5, -6], [6, -5], [7, -4], [45, 50]]
...
def clusterize():
	...
	L = 3 #
	I = 8 # max number of iterations
	N_c = 5 # number of primary cluster centers
